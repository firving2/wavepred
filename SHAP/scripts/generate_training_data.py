...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="D:\mul-station tide level\interprediciton\GCRNN_PyTorch-main/data/Mexico_province/Mexico_temperature/", help="Output directory.")
    parser.add_argument("--temperature_filename", type=str,
                        default="D:\mul-station tide level\interprediciton\GCRNN_PyTorch-main/data/Mexico_province/Mexico_temperature/42002h3.npy",

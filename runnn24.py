...
def shap1(args):
    with open(args.config_filename) as f:
        ...
        checkpoint = torch.load('models24z/epo3924diyici.tar' , map_location='cpu')  # 加载模型参数
        ...
        for j in range(4):
            ...
            swh2 = np.zeros((100*24, len(latitude), len(longitude)))  # 创建新的swh2数组
            swh3 = np.zeros((100*24, len(latitude), len(longitude)))  # 创建新的swh3数组
        ...
        # print(ss)
        np.save('shap_values_24h503z2', shap_values)

...
def visualization_dcrnn_prediction(filename: str):
    ...
    prediction = f["prediction"][:,:146,:] # (12, 256, 74)
    ...
    inv_y= inv_y.transpose(1, 0,2)
    print(inv_y.shape)

    inv_yhat = inv_yhat.transpose(1,0,2)
    #
    inv_y = inv_y[:,:, :]
    inv_yhat = inv_yhat[:,:,:]
    # print(inv_y.shape)
    # inv_y = inv_y.reshape(-1,inv_yhat.shape[2])
    # # # # inv_y = inv_y[:,:]
    # # # # print(inv_y.shape)
    ...
    # # # #
    # # # #
    # inv_yhat = inv_yhat.reshape(-1,inv_yhat.shape[2])
    # # # # inv_yhat = inv_yhat[:,:]

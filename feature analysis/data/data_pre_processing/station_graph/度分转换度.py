...
if __name__ == "__main__":
    station_number, lat, long = read_file(r"D:\mul-station tide level\why factors\GCRNN_PyTorch-main\data\Mexico_province\station_graph\fxc.xlsx") # 站点、纬度、经度
    print(type(lat))
    save = [] # 保存计算的值
    ...
    f.to_csv(r"D:\mul-station tide level\why factors\GCRNN_PyTorch-main\data\Mexico_province\station_graph\latitude_and_longitudefxc.csv", index=None)

...
def jisuan_jiedian_juli(filename):
    ...
    f.to_csv(r"D:/mul-station tide level/why factors/GCRNN_PyTorch-main\data\Mexico_province\station_graph\distances_fxc.csv", index=None)
...
def jiaodu_zhuanhuan_hudu(degree_minute):
    ...
    rad = degree_minute * math.pi / 180
    return rad


if __name__ == "__main__":
    jisuan_jiedian_juli(r"D:/mul-station tide level/why factors/GCRNN_PyTorch-main\data\Mexico_province\station_graph\fxc.xlsx")
    print("finish!")
